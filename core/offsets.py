...
class Offsets:
    ...
    def update(self, offsets_path: str = "offsets.json", client_path: str = "client.dll.json") -> bool:
        ...
        # Format: cli["client.dll"]["classes"]["ClassName"]["fields"]["field"]
        # Deger int veya {"offset": int, "type": str} olabilir
        def field(cls: str, name: str) -> int:
            val = cli.get("client.dll", {}).get("classes", {}).get(cls, {}).get("fields", {}).get(name, 0)
