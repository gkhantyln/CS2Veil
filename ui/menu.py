...
class MenuConfig:
    def __init__(self):
        ...
        self.distance_color     = [1.0, 1.0, 1.0, 1.0]
        ...
        self.player_name_color  = [1.0, 1.0, 1.0, 1.0]
        self.show_line_to_enemy = False
        self.box_thickness      = 1.0   # 0.1 - 2.0
        self.box_width_scale    = 1.0   # Genislik carpani (0.5 - 2.0)
        self.box_height_scale   = 1.0   # Yukseklik carpani (0.5 - 2.0)
...
def render_menu():
    ...
    if imgui.begin_tab_item("Gorsel")[0]:
        ...
        _, menu_config.box_width_scale = imgui.slider_float(
            "Kutu Genisligi##bw", menu_config.box_width_scale, 0.5, 2.0, "%.2f")
        _, menu_config.box_height_scale = imgui.slider_float(
            "Kutu Yuksekligi##bh", menu_config.box_height_scale, 0.5, 2.0, "%.2f")
